...
# User
TripGostation.destroy_all #will create trip_gostaion in user:after_create
User.destroy_all
...
Site.create!(name: "龍山寺", latitude: 25.037162, longitude: 121.499901, trip_id: trip_id,
             ...
             photo: "sites/4/3.jpg")
Site.create!(name: "指南宮", latitude: 24.979824, longitude: 121.586626, trip_id: trip_id,
             description: "到木柵，坐覽車，看企鵝，喝茶賞月亮，還可以幹什麼?你還可以走訪指南宮，偷偷告訴月老你的理想型，讓他幫你牽紅線喔!事不宜遲，現在就出發告訴月老去!",
             photo: "sites/4/4.jpg")
Site.create!(name: "照明淨寺", latitude: 25.131610, longitude: 121.513813, trip_id: trip_id,
...
# --- trip 3
trip_id = 3
Site.create!(name: "老梅綠石槽", latitude: 25.292095, longitude: 121.545457, trip_id: trip_id,
             description: "位於北海岸石門區老梅里的綠石槽海岸，為全台唯一特殊景觀，綠石槽只出現在四、五月份，隨後海藻就在夏日陽光的曝曬下而消失，這段短暫而美麗的季節中，你還在等什麼呢?現在就接受挑戰吧!",
             photo: "sites/5/1.jpg")
Site.create!(name: "淺水灣", latitude: 25.251475, longitude: 121.469913, trip_id: trip_id,
             description: "三芝的淺水灣就像台北的峇里島，來到三芝除了曬太陽，享受海風，還可以選家喜歡的露天咖啡店，聽聽Live演唱，會更有情調喔!上傳照片告訴我們你去了哪裡吧!",
             photo: "sites/5/2.jpg")
Site.create!(name: "淡水紅毛城", latitude: 25.175435, longitude: 121.432942, trip_id: trip_id,
             description: "你還記得歷史課本裡的紅毛城嗎?現在還搞不清楚，到底是西班牙人建的，還是葡萄牙人建的嗎?在淡水除了有紅毛城，還有小白宮，滬尾偕醫館等等洋樓風格的建築喔!不知道還以為到了歐洲一趟了呢!走!今天就出發去歐洲!",
             photo: "sites/5/3.jpg")
Site.create!(name: "北投溫泉博物館", latitude: 25.136577, longitude: 121.507154, trip_id: trip_id,
             ...
             photo: "sites/5/4.jpg")
Site.create!(name: "士林夜市", latitude: 25.087868, longitude: 121.524077, trip_id: trip_id,
...
# --- trip 4
trip_id = 4
Site.create!(name: "四色草隧道", latitude: 23.019634, longitude: 120.136141, trip_id: trip_id,
             description: "四色草隧道是台版的「亞馬遜河」喔!沒去過亞馬遜，但你可以來四色草隧道!到這裡要先把gogoro停一邊，換上救生衣，坐船出發體驗去!",
             photo: "sites/6/1.jpg")
Site.create!(name: "幾米主題公園", latitude: 23.108510, longitude: 120.270209, trip_id: trip_id,
             description: "在台南科學園區的各個角落，有著幾米繪本裡的可愛場景和角色喔!你知道總共藏著幾隻貓嗎?快去算一算吧!把你的答案留在下面!",
             photo: "sites/6/2.jpg")
Site.create!(name: "奇美博物館", latitude: 22.934783, longitude: 120.226068, trip_id: trip_id,
             description: "到台南不能只能顧著吃小吃，還要來一趟文化的享宴，奇美博物館座落台南都會公園，是台南必到打卡景點，就像到英國，要去白金漢宮，到法國要到凡爾賽宮，到台南就要到奇美博物館，感受不輸國外的氛圍吧!",
             photo: "sites/6/3.jpg")
Site.create!(name: "黃金海岸", latitude: 22.933209, longitude: 120.176258, trip_id: trip_id,
             description: "台南原來離海那麼近?在市區玩膩了，就出發到黃金海岸吧!黃昏的時候一望無垠的海岸，被夕陽染紅，走在閃閃發光的沙灘上，非常浪漫喔!",
             photo: "sites/6/4.jpg")
Site.create!(name: "赤崁樓", latitude: 22.997478, longitude: 120.202543, trip_id: trip_id,
...
Site.create!(name: "士林夜市", latitude: 25.087868, longitude: 121.524077, trip_id: trip_id,
             description: "士林夜市是臺北市範圍最大的夜市，也是國外觀光客造訪臺北必到的觀光夜市，走一趟士林，各種一網打盡各種好吃好玩的。不要錯過香噴噴的「豪大大雞排」外脆內嫩，搭配一杯好喝的「青蛙下蛋」和香氣四溢的「士林大香腸」，現在就出發士林夜市，解放你的味蕾吧。",
             photo: "sites/1/1.jpg")
Site.create!(name: "寧夏夜市", latitude: 25.056853, longitude: 121.515545, trip_id: trip_id,
             ...
             photo: "sites/1/2.jpg")
Site.create!(name: "臨江夜市", latitude: 25.030280, longitude: 121.554239, trip_id: trip_id,
             description: "聽過臨江夜市嗎?不想和觀光客人擠人?只有在地人才知道的臨江夜市，絕對是你的好選擇。這裡的青島豆漿，愛玉之夢遊仙草，是你在其它夜市找不到的好口味!逛完夜市，腳痛腿麻了?別忘了對自己好一點，試試臨江夜市最有名的腳底按摩!",
             photo: "sites/1/3.jpg")
Site.create!(name: "饒河街夜市", latitude: 25.050906, longitude: 121.577648, trip_id: trip_id,
