...
namespace :dev do
  ...
  task create_site_info: :environment do
    ...
    Site.create!(name: "士林夜市", latitude: 25.087868, longitude: 121.524077, trip_id: 1,
                 ...
                 photo: File.open(Rails.root.join("app/assets/images/challenges/Market/1.jpg")))
    Site.create!(name: "寧夏夜市", latitude: 25.056853, longitude: 121.515545, trip_id: 1,
                 ...
                 photo: File.open(Rails.root.join("app/assets/images/challenges/Market/2.jpg")))
    Site.create!(name: "臨江夜市", latitude: 25.030280, longitude: 121.554239, trip_id: 1,
                 ...
                 photo: File.open(Rails.root.join("app/assets/images/challenges/Market/3.jpg")))
    Site.create!(name: "饒河街夜市", latitude: 25.050906, longitude: 121.577648, trip_id: 1,
                 ...
                 photo: File.open(Rails.root.join("app/assets/images/challenges/Market/4.jpg")))
    Site.create!(name: "師大夜市", latitude: 25.024542, longitude: 121.529366, trip_id: 1,
                 ...
                 photo: File.open(Rails.root.join("app/assets/images/challenges/Market/5.jpg")))
    Site.create!(name: "華西街夜市", latitude: 25.038599, longitude: 121.498443, trip_id: 1,
                 ...
                 photo: File.open(Rails.root.join("app/assets/images/challenges/Market/6.jpg")))
    ...
    Site.create!(name: "寶山水庫", latitude: 24.752685, longitude: 121.045577, trip_id: 2,
                 ...
                 photo: File.open(Rails.root.join("app/assets/images/challenges/Hsinchu/1.jpeg")))
    Site.create!(name: "牛欄河親水公園", latitude: 24.792248, longitude: 121.180862, trip_id: 2,
                 ...
                 photo: File.open(Rails.root.join("app/assets/images/challenges/Hsinchu/2.jpg")))
    Site.create!(name: "南寮漁港", latitude: 24.849806, longitude: 120.929003, trip_id: 2,
                 ...
                 photo: File.open(Rails.root.join("app/assets/images/challenges/Hsinchu/3.jpg")))
    Site.create!(name: "頭前溪豆腐岩", latitude: 24.799891, longitude: 121.029656, trip_id: 2,
                 ...
                 photo: File.open(Rails.root.join("app/assets/images/challenges/Hsinchu/4.jpg")))
    Site.create!(name: "城隍廟", latitude: 24.804244, longitude: 120.966147, trip_id: 2,
                 ...
                 photo: File.open(Rails.root.join("app/assets/images/challenges/Hsinchu/5.jpg")))
    ...
    Site.create!(name: "永康牛肉麵", latitude: 25.032912, longitude: 121.528107, trip_id: 3,
                 ...
                 photo: File.open(Rails.root.join("app/assets/images/challenges/Beefnoodle/1.jpg")))
    Site.create!(name: "牛爸爸牛肉麵", latitude: 25.068905, longitude: 121.594530, trip_id: 3,
                 ...
                 photo: File.open(Rails.root.join("app/assets/images/challenges/Beefnoodle/2.jpg")))
    Site.create!(name: "史記牛肉麵", latitude: 25.057872, longitude: 121.529621, trip_id: 3,
                 ...
                 photo: File.open(Rails.root.join("app/assets/images/challenges/Beefnoodle/3.jpg")))
    Site.create!(name: "穆記牛肉麵", latitude: 25.027460, longitude: 121.563385, trip_id: 3,
                 ...
                 photo: File.open(Rails.root.join("app/assets/images/challenges/Beefnoodle/4.jpg")))
    Site.create!(name: "林東芳牛肉麵", latitude: 25.046479, longitude: 121.541711, trip_id: 3,
                 ...
                 photo: File.open(Rails.root.join("app/assets/images/challenges/Beefnoodle/5.jpg")))
    ...
    Site.create!(name: "霞海城隍廟", latitude: 25.055609, longitude: 121.510162, trip_id: 4,
                 ...
                 photo: File.open(Rails.root.join("app/assets/images/challenges/Temple/1.jpg")))
    Site.create!(name: "四面佛", latitude: 25.054424, longitude: 121.533588, trip_id: 4,
                 ...
                 photo: File.open(Rails.root.join("app/assets/images/challenges/Temple/2.jpg")))
    Site.create!(name: "龍山寺", latitude: 25.037162, longitude: 121.499901, trip_id: 4,
                 ...
                 photo: File.open(Rails.root.join("app/assets/images/challenges/Temple/3.jpg")))
    Site.create!(name: "指南宮", latitude: 24.979824, longitude: 121.586626, trip_id: 4,
                 ...
                 photo: File.open(Rails.root.join("app/assets/images/challenges/Temple/4.jpg")))
    Site.create!(name: "照明淨寺", latitude: 25.131610, longitude: 121.513813, trip_id: 4,
                 ...
                 photo: File.open(Rails.root.join("app/assets/images/challenges/Temple/5.jpg")))
    ...
    Site.create!(name: "老梅綠石槽", latitude: 25.292095, longitude: 121.545457, trip_id: 5,
                 ...
                 photo: File.open(Rails.root.join("app/assets/images/challenges/Northshore/1.jpeg")))
    Site.create!(name: "淺水灣", latitude: 25.251475, longitude: 121.469913, trip_id: 5,
                 ...
                 photo: File.open(Rails.root.join("app/assets/images/challenges/Northshore/2.jpg")))
    Site.create!(name: "淡水紅毛城", latitude: 25.175435, longitude: 121.432942, trip_id: 5,
                 ...
                 photo: File.open(Rails.root.join("app/assets/images/challenges/Northshore/3.jpg")))
    Site.create!(name: "北投溫泉博物館", latitude: 25.136577, longitude: 121.507154, trip_id: 5,
                 ...
                 photo: File.open(Rails.root.join("app/assets/images/challenges/Northshore/4.jpg")))
    Site.create!(name: "士林夜市", latitude: 25.087868, longitude: 121.524077, trip_id: 5,
                 description: "士林夜市是臺北市範圍最大的夜市，也是國外觀光客造訪臺北必到的觀光夜市，走一趟士林，各種一網打盡各種好吃好玩的。不要錯過香噴噴的「豪大大雞排」外脆內嫩，搭配一杯好喝的「青蛙下蛋」和香氣四溢的「士林大香腸」，現在就出發士林夜市，解放你的味蕾吧。",
                 photo: File.open(Rails.root.join("app/assets/images/challenges/Northshore/5.jpg")))
    ...
    Site.create!(name: "四色草隧道", latitude: 23.019634, longitude: 120.136141, trip_id: 6,
                 ...
                 photo: File.open(Rails.root.join("app/assets/images/challenges/Tainan/1.jpg")))
    Site.create!(name: "幾米主題公園", latitude: 23.108510, longitude: 120.270209, trip_id: 6,
                 ...
                 photo: File.open(Rails.root.join("app/assets/images/challenges/Tainan/2.jpg")))
    Site.create!(name: "奇美博物館", latitude: 22.934783, longitude: 120.226068, trip_id: 6,
                 ...
                 photo: File.open(Rails.root.join("app/assets/images/challenges/Tainan/3.jpg")))
    Site.create!(name: "黃金海岸", latitude: 22.933209, longitude: 120.176258, trip_id: 6,
                 ...
                 photo: File.open(Rails.root.join("app/assets/images/challenges/Tainan/4.jpg")))
    Site.create!(name: "赤崁樓", latitude: 22.997478, longitude: 120.202543, trip_id: 6,
                 ...
                 photo: File.open(Rails.root.join("app/assets/images/challenges/Tainan/5.jpg")))
